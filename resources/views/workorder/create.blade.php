                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h3 class="card-title" id="">
                                <div class="row" style="margin-top: -10px">
                                    <div class="col-md-12" style=""> New Work Orders
                                        {{-- <a href="{{ route('workorder.index') }}" class="btn btn-float btn-outline-dark btn-round btn-sm ml-2" data-toggle="tooltip" title="View All Work Order"><i class="la la-list"></i></a> --}}
                                    </div>
                                </div>
                            </h3>
                            ...
                            <div id="smartwizard">
                                <ul class="nav">
                                    ...
                                    <li> <a class="nav-link" href="#step-5"> Comment & Signatures </a> </li>
                                          ...
                                          <div class="card-content collapse show">
                                            <div class="card-body card-border">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea name="header" oncopy="return false;" id="header" cols="100%" rows="20">{{$default->header}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="card-content collapse show">
                                            <div class="card-body card-border">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" step="0.02" class="form-control" name="vat" id="vat" value="">
                                                    </div>
                                                </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="card-content collapse show">
                                            <div class="card-body card-border">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea oncopy="return false;" name="comment" id="comment" cols="100%" rows="20">{{$default->comment}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                          </div>
...
@section('scripts')
    ...
    <script>
        ...
        CKEDITOR.replace( 'header' ).on('paste',function(e){e.cancel();});
    ...
    <script>
        ...
        CKEDITOR.replace( 'comment' ).on('paste',function(e){e.cancel();});
        // CKEDITOR.instances.editor1.on('copy',function(e){e.cancel();});
        // $('body').bind('copy',function(e){e.preventDefault(); return false;});
    </script>
