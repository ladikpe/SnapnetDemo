                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col text-right">
                                            ...
                                            <div class="btn-group d-none d-md-block float-right ml-2" role="group" aria-label="Basic example">
                                              @if($vendor->status == 0)
                                                <button type="button" class="btn btn-success" disabled=""><i class="la la-dashcube"></i> Awaiting Approval</button>
                                            ...
                                            <ul class="nav nav-tabs nav-iconfall about">
                                              ...
                                              <li class="nav-item">
                                                <a class="nav-link pull-right">
                                                    <button type="button" class="btn btn-outline-success btn-glow btn-sm" data-toggle="modal" data-target="#aboutModal" style="cursor: pointer;"><i class="fa fa-plus"></i> Add Company Profile</button>
                                                </a>
                                              </li>
                                            </ul>
                                            <div class="tab-content px-1 pt-1">
                            ...
                            <div class="row no-pad">
                                                            ...
                                                            <tbody>      @php $i = 1; @endphp    
                                                                @forelse ($vendor_documents as $vendor_document)                
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $vendor_document->expiry_date }}</td>
                                                                        <td>
                                ...
                                <div class="col-md-4 pad-left pad-right">
                                    <fieldset class="scheduler-border" style="padding: 0 3.4em 1.4em 3.4em !important;">
                                        ...
                                        <form id="uploadDocumentForm" action="{{ route('upload-document-vendor') }}" enctype="multipart/form-data" method="POST"> @csrf
