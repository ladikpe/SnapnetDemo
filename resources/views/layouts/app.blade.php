...
<head>
  ...
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/app-assets/vendors/css/charts/chartist-plugin-tooltip.css') }}">
  <!-- END VENDOR CSS-->
  <!-- BEGIN MODERN CSS-->
  ...
  <!-- BEGIN VENDOR CSS-->
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/app-assets/vendors/css/extensions/raty/jquery.raty.css') }}">
  <!-- END VENDOR CSS-->
  ...
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/app-assets/fonts/line-awesome/css/line-awesome.min.css') }}">
  ...
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/app-assets/vendors/css/extensions/datedropper.min.css') }}">


  <!-- BEGIN Page Level CSS-->
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/app-assets/css/plugins/forms/checkboxes-radios.css') }}">
  <!-- END Page Level CSS-->
  ...
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/app-assets/vendors/js/gallery/photo-swipe/photoswipe.css') }}">
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/app-assets/vendors/js/gallery/photo-swipe/default-skin/default-skin.css') }}">
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/full-calendar/lib/main.css') }}">

  <!-- Signatures Css -->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/e-signature/css/jquery.signaturepad.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/e-signature/css/app_style.css') }}" />
...
<body class="horizontal-layout horizontal-menu 2-columns menu-expanded" data-open="hover" data-menu="horizontal-menu"
  ...
  <!-- fixed-top-->
  <nav
    class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow navbar-static-top navbar-light navbar-brand-left"
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="#">
              <img class="brand-logo" alt="PALIPRO-logo" src="{{ asset('assets/images/aa&r-logo.png') }}"
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
            ...
            <li class="dropdown nav-item mega-dropdown">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1"
                        src="{{ asset('assets/app-assets/images/slider/slider-2.png') }}" alt="First slide"><a
                        class="news-title mb-0" href="#"></a>
                ...
                <li class="col-md-5 pull-left">
                  <h6 class="dropdown-menu-header text-uppercase"><i class="la la-random"></i> Messages & Notifications
                  </h6>
                  <ul class="drilldown-menu">
                    ...
                    <li class="scrollable-container media-list w-100 ps-container ps-theme-dark"
                      data-ps-id="09e6161c-422e-c30f-5f20-0439881f8b48">
            ...
            <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="ficon ft-search"></i>
                <input class="input" type="text" class="form-control" placeholder="Search ..." name="q"
                  value="{{ request()->q }}" style="border-color: none none #ddd none !important;"></a>
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">{{ Auth::user()->name }}
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="{{route('change-password')}}"><i class="la la-edit"></i> Change Password</a>
                @if(Auth::user()->roles->id == 1)
                <a class="dropdown-item" href="{{ route('users') }}"><i class="la la-users"></i> Users</a>
                <a class="dropdown-item" href="{{ route('departments') }}"><i class="la la-bank"></i> Departments</a>
                @endif
                <a class="dropdown-item" href="{{ route('sign') }}"><i class="la la-pencil"></i> Signature</a>
                {{-- <a class="dropdown-item" href="{{ route('vendor.index') }}"><i class="la la-registered"></i>
                  Vendors</a> --}}
               ...
               document.getElementById('logout-form').submit();"><i class="la la-power-off"> </i> Logout
                </a>
            ...
            <li class="dropdown dropdown-user nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{ route('departments') }}"><i class="la la-bank"></i> Departments</a>
                <a class="dropdown-item" href="{{ route('requirements-and-filings.index') }}"> <i class="la la-calendar-check-o"></i> Requirements & Filings</a>
                <a class="dropdown-item" href="{{ route('messages') }}"><i class="la la-envelope-o"></i> Setup Email Messages</a>
                <a class="dropdown-item" href="{{ route('contract-type.index') }}"><i class="la la-file-text"></i> Contract Types</a>
                ...
                <a class="dropdown-item" href="{{ route('requirements-and-filings.index') }}"> <i class="la la-calendar-check-o"></i> Requirements & Filings</a>
                <a class="dropdown-item" href="{{ route('messages') }}"><i class="la la-envelope-o"></i> Setup Email Messages</a>
                <a class="dropdown-item" href="{{ route('contract-type.index') }}"><i class="la la-book"></i> Contract Types</a>
                <a class="dropdown-item" href="{{ route('assign-tasks') }}"><i class="la la-rotate-right"></i> Re-Assign Task </a>

                  @if(Auth::user()->department->department_head_id == Auth::user()->id)
                    <a class="dropdown-item" href="{{ route('delegate-role') }}"><i class="la la-arrow-circle-right"></i> Delegate Roles</a>
                  @endif
                @endif
              </div>
            </li>
  ...
  <div
    ...
    role="navigation" data-menu="menu-wrapper" style="background:#0c84d1;"> {{-- 5D8AA8 --}}
    <div class="navbar-container main-menu-content" data-menu="menu-container">
      ...
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation"
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span> <i
                class="la la-dashboard"></i>Dashboards</span></a>
          <ul class="dropdown-menu">
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('home') }}"> <i class="la la-home"></i>Home Dashboard</a>
            </li>
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('statutory-dashboard') }}"> <i
                  class="la la-dashboard"></i>Statutory Dashboard</a>
            </li>
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('task-dashboard') }}"> <i class="la la-dashboard"></i>Task
                Dashboard</a>
            </li>
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('contract-register-dashboard') }}"> <i
                  class="la la-dashboard"></i>Contract Register Dashboard</a>
            </li>
          </ul>
        </li>
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span> <i class="la la-list"></i>Requests </span></a>
          <ul class="dropdown-menu">
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('requests.index') }}"> <i class="la la-question"></i> Internal </a>
            </li>
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('request-externals') }}"> <i class="la la-question"></i> External
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('requisitions.index') }}"> <span><i class="la la-book"></i>Tasks</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="{{ route('assignments.index') }}"> <i class="la la-mail-forward"></i> Assignment
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('document-link-url') }}"> <i class="la la-link"></i> Shared Links </a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="{{ route('document-creations.index') }}"> <i class="la la-file-text"></i> Your Documents </a>
        </li>

        {{-- <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span> <i
                class="la la-file-text"></i>Documents </span></a>
          <ul class="dropdown-menu">
            @if(Auth::user()->roles->id == 2 || Auth::user()->roles->id == 3 || Auth::user()->roles->id == 4 ||
            Auth::user()->id == 2)
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('requisitions.index') }}"> <i class="la la-file"></i> Template
              </a>
            </li>
            @if(Auth::user()->roles->id == 3)
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('assignments.index') }}"> <i class="la la-mail-forward"></i>
                Assignment </a>
            </li>
            @elseif(Auth::user()->roles->id == 4 || Auth::user()->id == 2)
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('all-documents') }}"> <i class="la la-server"></i> Documents </a>
            </li>
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('document-creations.index') }}"> <i class="la la-plus-circle"></i>
                Document Creation </a>
            </li>
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('pending-reviews') }}"> <i class="la la-refresh"></i> Reviews </a>
            </li>
            <li data-menu="">
              <a class="dropdown-item" href="{{ route('pending-approvals') }}"> <i class="la la-check"></i> Approvals
              </a>
            </li>
            @endif
            <li data-menu=""><a class="dropdown-item" href="#"> </a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('documents.create') }}"> <i
                  class="la la-plus"></i>Create</a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('documents') }}"> <i
                  class="la la-list"></i>List</a> </li>
            @endif
          </ul>
        </li> --}}
        ...
        {{-- <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span> <i
                class="la la-bullseye"></i>Bids</span></a>
          <ul class="dropdown-menu">
            <li data-menu=""><a class="dropdown-item" href="{{ route('bids.index') }}"> <i
                  class="la la-fax"></i>Bids</a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('vendor-bids.index') }}"> <i
                  class="la la-check-circle-o"></i>Vendor Bids</a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('submitted-bids') }}"> <i
                  class="la la-calendar-check-o"></i>Submitted Bids</a> </li>
          </ul>
        </li>

        <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span><i
                class="la la-registered"></i>Vendor</span></a>
          <ul class="dropdown-menu"> --}}
            {{-- @if(Auth::user()->role_id == 5) --}}
            {{-- <li data-menu=""><a class="dropdown-item" href="{{ route('vendor-registration') }}"><i
                  class="la la-user-plus"></i> Vendor Registration </a> </li> --}}
            {{-- <li data-menu=""><a class="dropdown-item" href="{{ route('vendor.index') }}"> <i
                  class="la la-users"></i>Vendors </a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ url('vendor-shortlist/1') }}"> <i
                  class="la la-check-square"></i>Shortlist Vendors </a> </li> --}}
            {{-- @endif --}}
            {{--
          </ul>
        </li>
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span><i
                class="la la-paste"></i>Orders</span></a>
          <ul class="dropdown-menu">
            <li data-menu=""><a class="dropdown-item" href="{{ route('workorder.index') }}"> <i
                  class="la la-sticky-note"></i> Work Orders </a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('completion.index') }}"> <i
                  class="la la-check-square-o"></i> Job Completion </a> </li>

            <li data-menu=""><a class="dropdown-item" href="{{ route('purchase-template') }}"> <i
                  class="la la-sticky-note"></i> Template - Purchase Order </a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('purchase-order-requisition') }}"> <i
                  class="la la-pencil-square"></i> Requisition - Purchase Order </a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('purchase-order.index') }}"> <i
                  class="la la-list"></i> List All - Purchase Order</a> </li>

            <li data-menu=""><a class="dropdown-item" href="#"> <i class="la la-sticky-note"></i> Service Order
                Template</a> </li>
            <li data-menu=""><a class="dropdown-item" href="#"> <i class="la la-pencil-square"></i> Service Order
                Requisition</a> </li>
            <li data-menu=""><a class="dropdown-item" href="#"> <i class="la la-list"></i> Create Service Order</a>
            </li>

            <li data-menu=""><a class="dropdown-item" href="{{ route('quotation.index') }}"> <i
                  class="la la-file-text-o"></i> Quotation & Tender</a> </li>
          </ul>
        </li>
        --}}
        ...
        {{-- <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span><i
                class="la la-refresh"></i>Reviews</span></a>
          <ul class="dropdown-menu">
            <li data-menu=""><a class="dropdown-item" href="{{route('documents.reviews')}}"> <i
                  class="la la-thumbs-o-up"></i> Document Reviews </a> </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('performance.index') }}"> <i
                  class="la la-line-chart"></i> Performance Settings</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="{{ route('requirements-and-filings.index') }}"> <i
                  class="la la-cog"></i> Requirements & Filings</a>
            </li>
          </ul>
        </li>
        ...
        <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span><i
                class="la la-suitcase"></i>Contracts</span></a>
          <ul class="dropdown-menu">
            @if(Auth::user()->role_id == 5)
        ...
        <li class="nav-item" style="float: right">
          <a class="nav-link"
            href="http://support.snapnetsolutions.com/PaliproAARlogin?email={{Auth::user()->email}}&name={{Auth::user()->name}}"
            target="_blank">
            <span><i class="la la-info"></i>Support {{Auth::user()->user_roles}} </span> </a>
        </li>
      ...
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation"
        ...
        <li class="nav-item" style="float: right">
          <a class="nav-link" href="{{ route('requests.index') }}"> <span><i class="la la-list"></i>Requests </span>
          </a>
        </li>

        <li class="nav-item" style="float: right">
          <a class="nav-link" href="{{ route('requisitions.index') }}"> <span><i class="la la-list"></i>Tasks </span>
          </a>
        </li>
        {{-- <li class="nav-item" style="float: right">
          <a class="nav-link" href="{{ route('prefered-tamplates') }}"> <span><i class="la la-file"></i>Prefered
              Template </span> </a>
        </li> --}}

        <li class="nav-item" style="float: right">
          <a class="nav-link" href="{{ route('document-creations.index') }}"> <span><i class="la la-file-text"></i>Documents </span>
          </a>
        </li>
        ...
        @elseif(Auth::user()->roles->id == 4 || Auth::user()->id == 2)
        {{-- <li class="nav-item">
          <a class="nav-link" href="{{ route('pending-reviews') }}"> <i class="la la-refresh"></i> Reviews </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('pending-approvals') }}"> <i class="la la-check"></i> Approvals </a>
        </li> --}}
        @endif
...
{{-- Add Request MODAL form --}}
  ...
  <footer class="footer footer-static footer-dark navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      ...
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">Powered By <i class="la la-power"></i>
        <img src="{{ asset('assets/images/logo-white.png') }}" style="width: 18%"> </span>
    </p>
  </footer>
  ...
  @php $sign = \App\User::where('id', \Auth::user()->id)->first(); @endphp
  <!-- Signature Modal -->
  <form class="" method="post" enctype="multipart/form-data">
    @csrf
    <div class="modal fade text-left" id="signModal" tabindex="-1" role="dialog" aria-labelledby="signModal"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header bg-dark white">
            <label class="modal-title" id="rate_model"> Your Signature Here</label>
  ...
  <script src="{{ asset('assets/src/js/scripts/charts/chartjs/chart.js') }}"></script>
  ...
  <script src="{{ asset('assets/full-calendar/lib/main.js') }}"></script>
    ...
    $(function(e)
  {
    $(function()
    {
      $('#signAreas').signaturePad({drawOnly:true, drawBezierCurves:true, lineTop:90});
    });
...
// */
    ...
    {
       $('#signAreas').signaturePad().clearCanvas();
    });
