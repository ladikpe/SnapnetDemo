        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="#"><i class="la la-edit"></i> Edit Profile</a>
                @if(Auth::user()->roles->id == 1)
  ...
  role="navigation" data-menu="menu-wrapper" style="background:#318CE7;">   {{-- 5D8AA8 --}}  
    <div class="navbar-container main-menu-content" data-menu="menu-container">
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation" style="font-weight:lighter !important;">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('all-documents') }}"> <i class="la la-file-text"></i> Documents </a> 
        </li>
        @if(Auth::user()->roles->id == 2)
          <li class="nav-item" style="float: right">
            <a class="nav-link" href="{{ route('requisitions.index') }}"> <span><i class="la la-book"></i>Requisitions</span> </a>
          </li>
        @elseif(Auth::user()->roles->id == 3)
          <li class="nav-item">
            <a class="nav-link" href="{{ route('assignments.index') }}"> <i class="la la-mail-forward"></i> Assignment </a> 
          </li>
        @elseif(Auth::user()->roles->id == 4 || Auth::user()->id == 2)
          <li class="nav-item">
            <a class="nav-link" href="{{ route('document-creations.index') }}"> <i class="la la-plus"></i> New Document </a> 
          </li>
          <li class="nav-item">
        ...
        <li class="nav-item" style="float: right">
          <a class="nav-link" href="https://support.snapnet.com.ng/PRISlogin?email={{Auth::user()->email}}&name={{Auth::user()->name}}">
