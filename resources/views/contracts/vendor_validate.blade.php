...
<body class="horizontal-layout horizontal-menu 1-column  bg-lighten-2 menu-expanded fixed-navbar"
data-open="hover" data-menu="horizontal-menu" data-col="1-column" style="background-color:#eee"
  <!-- fixed-top-->
  <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-dark navbar-brand-center" style="background:#5D8AA8">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="#">
              <!-- <img class="brand-logo pull-left" alt="Pali365logo" src="{{ asset('assets/images/logo.png') }}" style="height:60%; text-align:left">
              <h5 class="brand-text" style="text-align:left">Pali365</h5> -->
            </a>
          </li>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  ...
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span>Access Contract with Pali365</span>
                  </h6>
                </div>
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('contract.vendor_validate') }}" novalidate>
                      @csrf
                     <input type="hidden" value=" {{$contract->id}}" name="contract_id">

                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="password" class="form-control input-lg {{ $errors->has('password') ? ' is-invalid' : '' }}" name="vendor_key" id="password" placeholder="Enter OTP"  tabindex="2" required data-validation-required-message="Please enter valid OTP.">
                      ...
                      <button type="submit" class="btn btn-dark btn-block btn-lg"><i class="ft-unlock"></i> Access Contract</button>
                    </form>
                  </div>
                </div>
  ...
  <footer class="footer footer-static footer-light navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; {{date('Y')}} 
          <a class="text-bold-800 grey darken-2" href="#" target="_blank">IHS </a>, All rights reserved. </span>
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">Powered By <i class="ft-heart pink"></i> SNAPNET</span>
    </p>
  </footer>
  ...
  <script type="text/javascript" src="{{ asset('assets/app-assets/vendors/js/ui/jquery.sticky.js') }}"></script>
  <script type="text/javascript" src="{{ asset('assets/app-assets/vendors/js/charts/jquery.sparkline.min.js') }}"></script>
  ...
  <!-- END MODERN JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script type="text/javascript" src="{{ asset('assets/app-assets/js/scripts/ui/breadcrumbs-with-stats.js') }}"></script>
