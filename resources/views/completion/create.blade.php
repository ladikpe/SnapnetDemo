                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h3 class="card-title" id="">
                                <div class="row" style="margin-top: -10px">
                                    <div class="col-md-12" style=""> New Job Completion
                                        {{-- <a href="{{ route('workorder.index') }}" class="btn btn-float btn-outline-dark btn-round btn-sm ml-2" data-toggle="tooltip" title="View All Purchase Order"><i class="la la-list"></i></a> --}}
                                    </div>
                                </div>
                            </h3>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-border">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="content" oncopy="return false;" id="content" cols="100%" rows="20">{{$default->completion}}</textarea>
                                        </div>
                                    </div>
                                </div>
                              </div>
